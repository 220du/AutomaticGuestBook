...
class Gui():
        ...
        while True:
            if ser.readable():
                ...
                if 0 < self.screen_num < 3:
                    ...
                    if check == 'None':
                        new = input_Name(
                            self.last_res, self.name, self.content)
                        warn_message = tkinter.messagebox.showinfo(
    ...
    def main_screen(self):
        ...
        User_button = Get_label.image_button(
            self, os.path.join(img_path, "../../images/btn1.png"), 20, 290, self.apply_screen)
        ...
        Data_1 = Get_label.image_label_text(
            self, os.path.join(img_path, "../../images/Data.png"), 32, 390, f"{self.user_data[1]} 소속 \n\n {self.user_data[0]}님 \n\n 회원가입 되셨습니다. ", "#472f91", ("고도 M", 24))
        Data_2 = Get_label.image_label_text(
            self, os.path.join(img_path, "../../images/Data.png"), 422, 390, f"{self.list_data[2]} 님 \n\n {self.list_data[0]} \n\n {self.list_data[1]} \n\n 방문하셨습니다.", "#472f91", ("고도 M", 24))
    ...
    def apply_screen(self):
        ...
        self.name_button = Get_label.image_button(
            self, os.path.join(img_path, "../../images/commit.png"), 560, 450, self.commit1)
        ...
        self.content_button = Get_label.image_button(
            self, os.path.join(img_path, "../../images/commit.png"), 560, 570, self.commit2)
        recommit_button = Get_label.image_button(
            self, os.path.join(img_path, "../../images/recommit.png"), 250, 700, self.apply_screen)
    ...
    def list_screen1(self):
        ...
        left_button = Get_label.image_button(
            self, os.path.join(img_path, "../../images/left.png"), 300, 40, self.no_action)
        ...
        self.Intro1 = Get_label.image_button_text(
            self, os.path.join(img_path, "../../images/li1.png"), 12, 133, self.no_action, f"", "#472f91", ("고도 M", 12))
        self.Intro2 = Get_label.image_button_text(
            self, os.path.join(img_path, "../../images/li2.png"), 62, 133, self.sort1, f"날짜", "#472f91", ("고도 M", 12))
        self.Intro3 = Get_label.image_button_text(
            self, os.path.join(img_path, "../../images/li3.png"), 272, 133, self.sort2, f"시간", "#472f91", ("고도 M", 12))
        self.Intro4 = Get_label.image_button_text(
            self, os.path.join(img_path, "../../images/li4.png"), 482, 133, self.sort3, f"이름", "#472f91", ("고도 M", 12))
        self.Intro5 = Get_label.image_button_text(
            self, os.path.join(img_path, "../../images/li5.png"), 612, 133, self.sort4, f"소속", "#472f91", ("고도 M", 12))
        ...
        for i in range(length1):
            li1 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li1-1.png"), 12, 173+(40*i), f"{i+1}", "#472f91", ("고도 M", 12))
            li2 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li2-1.png"), 62, 173+(40*i), f"{self.list[i][0]}", "#472f91", ("고도 M", 12))
            li3 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li3-1.png"), 272, 173+(40*i), f"{self.list[i][1]}", "#472f91", ("고도 M", 12))
            li4 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li4-1.png"), 482, 173+(40*i), f"{self.list[i][2]}", "#472f91", ("고도 M", 12))
            li5 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li5-1.png"), 612, 173+(40*i), f"{self.list[i][3]}", "#472f91", ("고도 M", 12))
    ...
    def list_screen2(self):
        ...
        for i in range(length1):
            li1 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li1-1.png"), 12, 173+(40*i), f"{i+16}", "#472f91", ("고도 M", 12))
            li2 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li2-1.png"), 62, 173+(40*i), f"{self.list[i+15][0]}", "#472f91", ("고도 M", 12))
            li3 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li3-1.png"), 272, 173+(40*i), f"{self.list[i+15][1]}", "#472f91", ("고도 M", 12))
            li4 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li4-1.png"), 482, 173+(40*i), f"{self.list[i+15][2]}", "#472f91", ("고도 M", 12))
            li5 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li5-1.png"), 612, 173+(40*i), f"{self.list[i+15][3]}", "#472f91", ("고도 M", 12))
    ...
    def list_screen3(self):
        ...
        for i in range(length1):
            li1 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li1-1.png"), 12, 173+(40*i), f"{i+31}", "#472f91", ("고도 M", 12))
            li2 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li2-1.png"), 62, 173+(40*i), f"{self.list[i+30][0]}", "#472f91", ("고도 M", 12))
            li3 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li3-1.png"), 272, 173+(40*i), f"{self.list[i+30][1]}", "#472f91", ("고도 M", 12))
            li4 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li4-1.png"), 482, 173+(40*i), f"{self.list[i+30][2]}", "#472f91", ("고도 M", 12))
            li5 = Get_label.image_label_text(
                self, os.path.join(img_path, "../../images/li5-1.png"), 612, 173+(40*i), f"{self.list[i+30][3]}", "#472f91", ("고도 M", 12))
